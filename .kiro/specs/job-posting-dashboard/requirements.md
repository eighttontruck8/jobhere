...
10. THE Analysis_Engine SHALL 파악 가능한 상세 내용만 표준 용어의 섹션별 개조식 문장으로 구성하고, 분류되지 않는 유용한 정보는 기타로 보존한다. 같은 의미의 섹션 제목은 하나의 표준 용어로 통일하며, 포함된 전형의 누락 날짜는 미정, 누락 장소는 추후 공지, 비대면 장소는 비대면으로 표시한다.
